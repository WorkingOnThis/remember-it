...
import { DotsVertical, Id } from "tabler-icons-react";
...
export const Deck = ({
  ...
  defaultDeck: string;
  setIdDeckSelected: (idDeckSelected: string) => void;
}) => {
  return (
      ...
      <div className="rounded-md border border-solid border-divider">
        <div className="grow-2 rounded-md rounded-bl-none rounded-br-none bg-secondary-dark">
          <div className="flex h-full min-h-[100px] w-full flex-row">
            <div
              className="flex min-h-[100px] w-full grow-2 cursor-pointer items-center justify-center border-y-0 border-r border-l-0 border-solid border-divider"
              onClick={() => setIdDeckSelected(id)}
            >
